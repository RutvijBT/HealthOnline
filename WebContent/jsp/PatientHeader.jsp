...
<%
	if(request.getSession().getAttribute("name")==null  || Integer.parseInt(request.getSession().getAttribute("role").toString())!=3){
  ...
  <div class="header" onmousemove="sendDoctor()">
    <div class="header_resize">
      ...
      <div class="clr"></div>
       ...
       <div class="menu_nav">
        <ul>
          <li class="active"><a href="/HealthOnlineProject/jsp/PatientHome.jsp"><span>Home</span></a></li>
          ...
          <li><a href="/HealthOnlineProject/jsp/chat.jsp"><span>Message</span></a></li>
