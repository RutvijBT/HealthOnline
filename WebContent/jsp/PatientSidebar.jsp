...
<div class="sidebar" onmousemove="sendInfo()">
        <div class="gadget">
          ...
          <ul class="sb_menu">
          <div id="my_sidebar">
            <li><a href="/HealthOnlineProject/Post.question">Home</a></li>
            <li><a href="/HealthOnlineProject/jsp/PatientProfile.jsp">Profile</a></li>
            <li><a href="/HealthOnlineProject/my.appointment">Appointment</a></li>
             <li><a href="/HealthOnlineProject/jsp/PatientQuestionaries.jsp">Questionaries</a></li>
             <li><a href="/HealthOnlineProject/jsp/MedicalHistory.jsp">Medical History</a></li>   
             <li><a href="/HealthOnlineProject/DoctorList">List of Doctors</a></li>
           
            
            <li><a href="/HealthOnlineProject/jsp/PatientRegDetail.jsp">Registration Details</a></li>
     ...
     <ul  class="sb_menu" >
         ...
         <!--div class="gadget">
          <h2 class="star"><span  class="side_header">Doctors</span></h2>
          <div class="clr"></div>
          <ul class="sb_menu">
            <li>Rutvij</li>
            <li>Manisha</li>
